    ...
    public class DiscoNegocio
    {
        public List<Disco> Listar()
        {
            ...
            try
            {
                ...
                comando.CommandText = "SELECT D.Id, D.Titulo, D.FechaLanzamiento, D.CantidadCanciones, E.Descripcion AS Genero, D.UrlImagenTapa, T.Descripcion AS Edicion FROM DISCOS D, ESTILOS E, TIPOSEDICION T \r\nWHERE D.IdEstilo = E.Id AND D.IdTipoEdicion = T.Id;";
